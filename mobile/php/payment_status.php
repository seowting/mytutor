...
$signed= hash_hmac('sha256', $signing, 'S-gbk5J2YlcIVADsICCh8zAQ');
if ($signed === $data['x_signature']) {
    if ($paidstatus == "Success"){ 
        ...
        $sqlupdatecart = "UPDATE `tbl_carts` SET `cart_status`='paid',`receipt_id`='$receiptid' WHERE user_email='$email' AND cart_status IS NULL";
